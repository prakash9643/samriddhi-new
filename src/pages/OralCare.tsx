...
const OralCarePage = () => {
  ...
  const capabilities = [
    { title: "Herbal Toothpaste", desc: "Crafted with neem, clove, and meswak for complete dental protection." },
    { title: "Charcoal Toothpaste", desc: "Advanced whitening formula with activated charcoal and peppermint." },
    { title: "Ayurvedic Mouthwash", desc: "Alcohol-free liquid with tea tree and basil for fresh breath." },
    { title: "Sensitive Care Gel", desc: "Specialized formulation to reduce tooth sensitivity naturally." },
    { title: "Kid's Herbal Gel", desc: "Fluoride-free, fruit-flavored toothpaste for gentle cleaning." },
    { title: "Gum Gels", desc: "Therapeutic gels for gum health and inflammation relief." }
  ];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              Premium <br />
              <span className="text-accent italic font-light">Oral Care</span>
            </motion.h1>
            
            <motion.p className="text-lg md:text-xl text-primary/60 font-medium max-w-xl mb-12">
              From herbal toothpastes to therapeutic mouthwashes, we manufacture next-gen oral hygiene solutions.
            </motion.p>
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
            <div className="aspect-[4/5] rounded-[4rem] overflow-hidden shadow-premium">
              <img src="/images/products/oral.png" alt="Oral Care" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-primary/60 font-medium text-lg">
              Advanced dental hygiene formulations using authentic herbal extracts
            </p>
          </div>
            ...
            {capabilities.map((item, i) => (
              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-primary/5 flex items-center justify-between">
                  <span className="text-[10px] font-black uppercase tracking-widest text-primary/30 group-hover:text-accent transition-colors">Oral Care</span>
      ...
      <section className="py-32 bg-primary text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none mb-8 uppercase">
            Launch Your <br /> <span className="text-accent italic font-light lowercase">Oral Care Brand</span>
          </h2>
