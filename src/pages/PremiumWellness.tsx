...
const PremiumWellnessPage = () => {
  const [isQuoteModalOpen, setIsQuoteModalOpen] = useState(false);

  const stats = [
    { label: 'Formulations', value: '40+' },
    { label: 'Brands', value: '15+' }
  ];

  const capabilities = [
    { title: "Pure Shilajit Resin", desc: "Sourced from high-altitude Himalayas, purified using traditional methods." },
    { title: "Gold Chyawanprash", desc: "Enriched with real gold, silver, and saffron for supreme vitality." },
    { title: "Saffron Syrup", desc: "Concentrated Kashmiri saffron extract for mood and skin health." },
    { title: "Musli Pak", desc: "A powerful nutritive tonic for strength and physical performance." },
    { title: "Specialized Avaleha", desc: "Customized jam-like herbal formulations for various therapeutic needs." },
    { title: "Immunity Honey", desc: "Infused with ginger, tulsi, and cinnamon for daily wellness." }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              Shilajit & <br />
              <span className="text-accent italic font-light">Chyawanprash</span>
            </motion.h1>
            
            <motion.p className="text-lg md:text-xl text-primary/60 font-medium max-w-xl mb-12">
              Processing premium Shilajit Resin, Chyawanprash, and specialized Avaleha formulations.
            </motion.p>
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
            <div className="aspect-[4/5] rounded-[4rem] overflow-hidden shadow-premium text-primary">
              <img src="/images/products/shilajit.png" alt="Premium Wellness" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-primary/60 font-medium text-lg">
              Specialized manufacturing for high-value Ayurvedic resins and revitalizing jalebis/confections
            </p>
          </div>
            ...
            {capabilities.map((item, i) => (
              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-primary/5 flex items-center justify-between">
                  <span className="text-[10px] font-black uppercase tracking-widest text-primary/30 group-hover:text-accent transition-colors">Premium Wellness</span>
      ...
      <section className="py-32 bg-primary text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-primary">
          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none mb-8 uppercase">
            Launch Your <br /> <span className="text-accent italic font-light lowercase">Premium Brand</span>
          </h2>
...
export default PremiumWellnessPage;
