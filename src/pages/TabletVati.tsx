...
const TabletVatiPage = () => {
  const [isQuoteModalOpen, setIsQuoteModalOpen] = useState(false);

  const stats = [
    { label: 'Formulations', value: '80+' },
    { label: 'Brands', value: '30+' }
  ];

  const capabilities = [
    { title: "Ghan Vati", desc: "Concentrated herbal extract tablets for digestive and immune support." },
    { title: "Liver Care Tablets", desc: "Powerful blend of Kutki and Punarnava for liver detoxification." },
    { title: "Joint Relief Tablets", desc: "Herbal compression formula for mobility and bone health." },
    { title: "Brahmi Vati", desc: "Classical preparation for memory, focus, and cognitive wellness." },
    { title: "Sarpagandha Vati", desc: "Authentic formulation for maintaining healthy blood pressure." },
    { title: "Triphala Tablets", desc: "Modern tablet format of the classic 3-fruit digestive blend." }
  ];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              Tablets & <br />
              <span className="text-accent italic font-light">Vati</span>
            </motion.h1>
            
            <motion.p className="text-lg md:text-xl text-primary/60 font-medium max-w-xl mb-12">
              Traditional Vati and modern tablet manufacturing with precision compression technology.
            </motion.p>
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
            <div className="aspect-[4/5] rounded-[4rem] overflow-hidden shadow-premium">
              <img src="/images/products/tablet.png" alt="Tablets" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-primary/60 font-medium text-lg">
              Combining ancient wisdom with modern precision compression for consistent dosage
            </p>
          </div>
            ...
            {capabilities.map((item, i) => (
              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-primary/5 flex items-center justify-between">
                  <span className="text-[10px] font-black uppercase tracking-widest text-primary/30 group-hover:text-accent transition-colors">Tablets</span>
      ...
      <section className="py-32 bg-primary text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none mb-8 uppercase">
            Launch Your <br /> <span className="text-accent italic font-light lowercase">Tablet Brand</span>
          </h2>
